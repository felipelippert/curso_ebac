...
var Pokemon = /*#__PURE__*/function () {
  ...
  _createClass(Pokemon, [{
    key: "attack",
    value: function attack(attackMove) {
      console.log("".concat(this.name, " used ").concat(attackMove, "!"));
    }
  }, {
    key: "attackReceived",
    value: function attackReceived() {
      _classPrivateFieldSet(this, _HP, _classPrivateFieldGet(this, _HP) - 10);
    }
  }, {
    key: "showsHP",
    value: function showsHP() {
...
var Pikachu = /*#__PURE__*/function (_Pokemon) {
  ...
  function Pikachu() {
    ...
    return _super.call(this, 'Pikachu', "Electric");
  }
  _createClass(Pikachu, [{
    key: "attack",
    value: function attack(attackMove) {
      console.log("".concat(this.name, " used Thundershock!"));
    }
  }]);
  return Pikachu;
}(Pokemon);
var AshsPikachu = new Pikachu();
